...
console.log('.controls { position: sticky; float: right; top: 16px; z-index: 999; }');
console.log('</style>');
console.log("<script>");
console.log("  const setBySelector = (selector, value) => {");
...
console.log("    });");
console.log("  }");
console.log("  const setTestDependencies = (event) => {");
console.log("    setBySelector('li.test', event.target.checked);");
console.log("  }");
console.log("  const setTransitiveDependencies = (event) => {");
console.log("    setBySelector('ul.transitive', event.target.checked);");
console.log("  }");
console.log("</script>");
console.log('</head>');
console.log('<body>');
console.log('<div class="controls">');
console.log('  <input type="checkbox" id="test-dependencies" checked="checked" /><label for="test-dependencies">Show test dependencies</label>');
console.log('  <input type="checkbox" id="transitive-dependencies" checked="checked" /><label for="transitive-dependencies">Show transitive dependencies</label>');
console.log('  <script>');
console.log('  const test = document.getElementById("test-dependencies");');
console.log('  const transitive = document.getElementById("transitive-dependencies");');
console.log('  test.addEventListener("change", setTestDependencies);');
